...
const API_Property_Like = async (data:requestType) : Promise<responseType> =>{
    ...
    try{
        ...
        const response:responseType =  await axios.post(process.env.BACKEND_URL + `/buyer/likeProperty/?property_id=${data.id}`,{},{
            headers:{
