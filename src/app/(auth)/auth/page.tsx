    ...
    const HandleSignIn = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.error && response.message) {
                toast.error(response.message, toastCompactTheme);
            } else {
            ...
            <div className={`w-full flex justify-center items-center bg-gray-50 p-4`}>
                ...
                >
                    ...
                    <div className={`w-full flex flex-col`}>
                        ...
                        <input name={`email`} className={`bg-gray-100 outline-0 py-1 rounded-md px-2`}
                    ...
                    <Button type={"submit"} variant={'solid'} size={'sm'} color={'primary'} isLoading={isSubmitting}>Sign
                        In</Button>
                    ...
                    <div className={`flex gap-1 justify-center text-xs items-center`}>
                        ...
                        <Link href={'buyer/signUp'} className={`font-semibold text-primary`}>Buyer</Link>
                        <span>
                          or
                        </span>
                        <Link href={'seller/signUp'} className={`font-semibold text-primary`}>Seller</Link>
                    </div>
                </form>
            </div>
